...
@router.get('')
def sessions(status: str | None = None, register_id: int | None = None, limit: int = Query(default=200, ge=1, le=500), db: Session = Depends(get_db), user=Depends(require_permissions('registers.view'))):
